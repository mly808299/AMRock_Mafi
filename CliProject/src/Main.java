...
public class Main {
    public static void main(String[] args) throws InvalidCourseException, NotFindCourseOfSemester, NotFindCurrentCourseException, NotFindStudentIdException, DoublicateAssignmentException, DoublicateException, DoublicateCourseException, InactiveCourseException, IOException, ClassNotFoundException {

//Person admin = new Admin("dfsgf" , "dzfsdg" , "xfgfdg" , "dsfsdg" , "dfsdf");
//
//        adminDatabaseObjects.writeObject(admin);
//        adminDatabaseObjects.flush();
//        adminDatabaseObjects.close();
//        ObjectInputStream adminDatabaseObjec = new ObjectInputStream(new FileInputStream("adminDatabaseObjects.txt"));
//       String id = ((Admin)adminDatabaseObjec.readObject()).getId();
